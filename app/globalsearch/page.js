      ...
      <div>
        <Navbar maxWidth={"full"}>
          <NavbarBrand onClick={() => router.push("/")}>
            <span
              className={
                "flex items-center space-x-2 text-3xl font-bold text-primary text-teal-300"
              }
            >
              Digital Rolodex
            </span>
        ...
        >
          ...
          <div className="relative inline-block text-left flex">
            <button
              ...
              className="text-white bg-teal-300 hover:bg-teal-500 focus:ring-4 focus:outline-none focus:ring-teal-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              type="button"
            >
